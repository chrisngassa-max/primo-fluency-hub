...
import { buildInteractiveS01, expandGrammarPoint } from "./generate-s01-interactive.mjs";
...
describe("S01 v3 — parcours interactif", () => {
  it("bloque une structure avec un nombre incohérent de réponses", () => {
    expect(() => expandGrammarPoint({
      point: "Présentation",
      items: ["Je ___.", "Tu ___."],
      reponses: ["suis"],
